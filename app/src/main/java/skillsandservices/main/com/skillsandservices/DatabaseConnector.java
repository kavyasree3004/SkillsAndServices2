...
private static final String quanity="QUANITY";
...
private static final String requesttable="USER_REQUESTS";
	...
	public void onCreate(SQLiteDatabase database) {
		...
		String createTableSQL1 = "CREATE TABLE " + requesttable + " (" + id +" INTEGER NOT NULL PRIMARY KEY, " + itemname +" TEXT, " + quanity
				+ " TEXT, " +contactno + " TEXT, " + date + " TEXT)";
	...
	public void addRecordRequest(String item, String weight, String contactnumber, String date1) {
		String insertSQL = "INSERT INTO " + requesttable + " (" + itemname + ", " + quanity + " ," + contactno +  ") "
				+ "VALUES" + " ('" + item + "', '" + weight + "', '" + contactnumber + "', '" + date1 + "')" ;
		Log.d("addRecord()", insertSQL);
		SQLiteDatabase dataBase = this.getWritableDatabase();
		dataBase.execSQL(insertSQL);
		dataBase.close();
	...
	public 	String getRecord1(String uname) {
		List<String> recordList = new ArrayList<String>(); 
		SQLiteDatabase dataBase = this.getReadableDatabase();
		String getSQL = "SELECT * FROM " + tableName + " WHERE " + username + " = '" + uname + "'" ;
		 Cursor cursor = dataBase.rawQuery(getSQL , null);
		 Log.d("getRecord()", getSQL + "Count = " + cursor.getCount());
		 cursor.moveToFirst();
		 String fName = cursor.getString(1);
		 ...
		 Log.d("getRecord()", "FirstName: " + fName + "LastName: " + lName + "Email: " + eMail + "Phone" + password);
		 recordList.add(fName);
		 recordList.add(lName);
		 recordList.add(eMail);
		 recordList.add(ph);
	...
	public 	String getRecord2(String uname) {
		List<String> recordList = new ArrayList<String>(); 
		SQLiteDatabase dataBase = this.getReadableDatabase();
		String getSQL = "SELECT * FROM " + tableName + " WHERE " + email + " = '" + uname + "'" ;
		 Cursor cursor = dataBase.rawQuery(getSQL , null);
		 Log.d("getRecord()", getSQL + "Count = " + cursor.getCount());
		 cursor.moveToFirst();
		 String fName = cursor.getString(1);
